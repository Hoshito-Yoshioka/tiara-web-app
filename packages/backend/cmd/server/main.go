...
func main() {
	...
	admin.GET("/reviews/profiles/:id", adminReviewHandler.GetProfileDraft)
	admin.PUT("/reviews/profiles/:id", adminReviewHandler.ReviewProfileDraft)
	admin.PUT("/reviews/profiles/:id/content", adminReviewHandler.UpdateProfileDraftContent)
	admin.GET("/reviews/schedules", adminReviewHandler.ListPendingScheduleDrafts)
	admin.GET("/reviews/schedules/:id", adminReviewHandler.GetScheduleDraft)
	admin.PUT("/reviews/schedules/:id", adminReviewHandler.ReviewScheduleDraft)
	admin.PUT("/reviews/schedules/:id/content", adminReviewHandler.UpdateScheduleDraftContent)
